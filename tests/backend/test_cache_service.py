...
@pytest.mark.asyncio
async def test_cache_and_get_job_status(fake_redis: fakeredis.aioredis.FakeRedis) -> None:
...
@pytest.mark.asyncio
async def test_get_cached_job_status_miss(fake_redis: fakeredis.aioredis.FakeRedis) -> None:
...
@pytest.mark.asyncio
async def test_invalidate_all_job_cache(fake_redis: fakeredis.aioredis.FakeRedis) -> None:
...
@pytest.mark.asyncio
async def test_cache_overwrites_existing(fake_redis: fakeredis.aioredis.FakeRedis) -> None:
